...
class GarageExternalRepositoryAdapterTest(
    ...
    fun shouldAskWebClientToGetFirstGarageLoadWhenLoadingGarageFirstTime() {
        ...
        StepVerifier.create(repositoryAdapter.loadGarageFirstTime()).verifyComplete()
    ...
    fun shouldConvertReceivedGarageWithSectorsAndSpotsWhenLoadingGarageFirstTime() {
        val spot = buildSomeSpotDTO()
        val sector = buildSomeGarageSectorDTO()
        val garage = buildSomeGarageResponse(sector = sector, spot = spot)
                ...
                assertThat(garage,allOf(
                    ...
                    hasProperty("sectors",allOf(
                        ...
                        contains(allOf(
                            ...
                            hasProperty("closedHour", equalTo(sector.closeHour)),
